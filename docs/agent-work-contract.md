...
This reference applies when orchestration or model migration is involved.
For repository authorization and delivery, follow `../AGENTS.md`. All code paths
below are repository-root-relative; installation and activation remain separate.
